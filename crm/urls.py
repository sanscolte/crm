...
urlpatterns = [
    ...
    path(
        ...
        CreateAdvertisingCampaignView.as_view(),
        name="create_advertising_campaign",
    ),
    path(
        "create-potential-client/",
        CreatePotentialClientView.as_view(),
        name="create_potential_client",
    ),
    path("create-contract/", CreateContractView.as_view(), name="create_contract"),
    path(
        "create-active-client/<int:pk>",
        CreateActiveClientView.as_view(),
        name="create_active_client",
    ),
    ...
    path(
        "potential-clients/",
        PotentialClientListView.as_view(),
    ...
    path(
        "active-clients/<int:pk>/delete/",
        ActiveClientDeleteView.as_view(),
        name="active_client_delete",
    ),
    path(
        "services/<int:pk>/update/", ServiceUpdateView.as_view(), name="service_update"
    ),
    path(
        "advertising-campaigns/<int:pk>/update/",
        AdvertisingCampaignUpdateView.as_view(),
        name="advertising_campaign_update",
    ),
    path(
        "potential-clients/<int:pk>/update/",
        PotentialClientUpdateView.as_view(),
        name="potential_client_update",
    ),
    path(
    ...
    path(
        "active-clients/<int:pk>/update/",
        ActiveClientUpdateView.as_view(),
        name="active_client_update",
    ),
    path(
        "statistics/",
        cache_page(settings.CACHE_TIME)(StatisticsView.as_view()),
        name="statistics",
    ),
]
